...
import (
	...
	appv1 "github.com/ClareChu/tigger/operator/pkg/apis/app/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &appv1.Pipeline{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *appv1.Pipeline) *corev1.Pod {
